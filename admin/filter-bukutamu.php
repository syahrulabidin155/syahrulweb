  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="report-harianbt.php" method="POST">
            <div class="col-md-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form action="report-bulananbt.php" method="POST">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form action="report-tahunanbt.php" method="POST">
            <div class="col-md-12">
