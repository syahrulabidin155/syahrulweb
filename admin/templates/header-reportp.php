...
<head>
  ...
  <title>Report Data Pengaduan Barang</title>
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/bps.jpg" alt="SI-PEKERBA" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">SIM BPS</span>
    </a>
