  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="report-harianp.php" method="POST">
            <div class="col-md-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form action="report-bulananp.php" method="POST">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form action="report-tahunanp.php" method="POST">
            <div class="col-md-12">
